...
namespace MemExchange.Tests.Server.NewBook
{
    ...
    public class OrderBookTests
    {
        ...
        public void HigherBuyOrderShouldMatchLowerSellOrdersAndPlaceBuyOrderInBookOnRestQuantity()
        {
            ...
            book.HandleOrder(sellOrder1);
            book.HandleOrder(sellOrder2);
            book.HandleOrder(sellOrder3);
            book.HandleOrder(sellOrder4);
            book.HandleOrder(sellOrder5);
